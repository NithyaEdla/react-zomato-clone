    ...
    <div className='restaurants max-width'>
        ...
        <div className='restaurants-grid'>
            {restaurantsList.map((restaurants)=>{
                return <div>
                    <div className='restaurants-cover'>
                        <img src={restaurants.cover} className='restaurants-image' alt={restaurants.rating} />
                        <div className='restaurants-title'>{restaurants.title}</div>
                        <div className='restaurants-rating'>{restaurants.rating}</div>
                        <div className='restaurants-items'>{restaurants.items}</div>
                    </div>
                </div>
            })}
        </div>
